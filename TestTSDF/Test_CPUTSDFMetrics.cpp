...
TEST( TSDF_CPU_Metrics, givenPositiveOffsetWithSpecificSizeWhenGettingCentreOfVolumeThenCentreIsReturnedAccurately ) {
    ...
    CPUTSDFVolume * volume = (CPUTSDFVolume *)TSDFVolume::make_volume(TSDFVolume::CPU, size, Eigen::Vector3f{100, 50, 20} );
...
TEST( TSDF_CPU_Metrics,  givenSizedVolumeWhenFindingCentreOfVolumeCentreIsCorrect) {
    ...
    CPUTSDFVolume * volume = (CPUTSDFVolume *)TSDFVolume::make_volume(TSDFVolume::CPU, size, physical_size );
...
TEST( TSDF_CPU_Metrics,  givenSizedVolumeWhenFindingVoxelBoundssAt_0_0_0_ThenBoundsAreCorrect) {
    ...
    CPUTSDFVolume * volume = (CPUTSDFVolume *)TSDFVolume::make_volume(TSDFVolume::CPU, Eigen::Vector3i{ 4, 3, 2 }, Eigen::Vector3f{1000.0f, 2000.0f, 3000.0f} );
...
TEST( TSDF_CPU_Metrics,  givenVolumeWhenFindingValidVoxelThenReturnsTrue) {
    ...
    CPUTSDFVolume * volume = (CPUTSDFVolume *)TSDFVolume::make_volume(TSDFVolume::CPU, Eigen::Vector3i{ 4, 5, 6 } );
